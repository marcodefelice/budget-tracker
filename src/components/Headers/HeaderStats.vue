...
export default {
  ...
  methods: {
    ...
    getWalletPlanned() {
      axios.get(DOMAIN + "/api/stats/wallet-planned", {
        headers: X_API_KEY,
      }).then((resp) => {
        let data = resp.data
    ...
    getMonthIncoming() {
      axios.get(DOMAIN + "/api/stats/month-wallet/incoming", {
        headers: X_API_KEY,
      }).then((resp) => {
        let data = resp.data
    ...
    getMonthexpenses() {
      axios.get(DOMAIN + "/api/stats/month-wallet/expenses", {
        headers: X_API_KEY,
      }).then((resp) => {
        let data = resp.data
    ...
    getWallets() {
      axios.get(DOMAIN + "/api/stats/wallets", {
        headers: X_API_KEY,
      }).then((resp) => {
        let data = resp.data
        data.forEach(e => {
